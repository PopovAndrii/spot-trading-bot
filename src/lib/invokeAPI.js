...
class InvokeApi {
    ...
    async newOrder() {
        try {
                ...
                console.log('✅ newOrder():', [ res.data.symbol, res.data.status, res.data.side, res.data.price, res.data.origQty ]);
                return res.data;
    ...
    async getOrder() {
        try {
            ...
            console.log('✅ getOrder():', [ res.data.symbol, res.data.status, res.data.side, res.data.price, res.data.origQty ]);
            return res.data;
